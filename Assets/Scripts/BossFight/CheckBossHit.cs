...
public class CheckBossHit : MonoBehaviour
{
    ...
    public GameObject HealthbarHit5;
    public GameObject HealthbarHit6;
    ...
    private void Awake()
    {
        ...
        HealthbarHit5.SetActive(false);
        HealthbarHit6.SetActive(false);
    }
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        if (numberOfBossHits == 5)
        {
            StartCoroutine(ShowHealthbarHit5());
        }
        
        if (numberOfBossHits == 6)
        {
            StartCoroutine(hitText2Routine());
            StartCoroutine(ShowHealthbarHit6());
        }
    ...
    IEnumerator ShowHealthbarHit5()
    {
        HealthbarHit5.SetActive(true);
        yield return new WaitForSeconds(2);
        HealthbarHit5.SetActive(false);
    }

    IEnumerator ShowHealthbarHit6()
    {
        HealthbarHit6.SetActive(true);
        yield return new WaitForSeconds(2);
        HealthbarHit6.SetActive(false);
    }
}
